...
function popCharts(str) {
	for (var i = 0; i < str.length; i++) {
		console.log("This week's chart buster is: " + str[i] + ".");
	}
}
popCharts(topFive);
...
function deadPresidents(str) {
	for (var i = 0; i < str.length; i++) {
		console.log("The value at " + i + " is " + str[i] + ".");
	}
}
deadPresidents(presidents);
